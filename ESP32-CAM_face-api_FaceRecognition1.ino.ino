...
//輸入WIFI連線帳號密碼
const char* ssid = "Desktop_F4517922";
const char* password = "37281079";  //your network password
...
static const char PROGMEM INDEX_HTML[] = R"rawliteral(
  ...
  <script src='https:\/\/13181leo.github.io/Alice/TensorFlow/Face-api/face-api.min.js'></script>
  </head><body>
  ...
  <script>
    const faceImagesPath =  'https://13181leo.github.io/Alice/TensorFlow/Face-api/facelist/';  
    const faceLabels = ['France', 'Terry', 'Leo'];
    faceImagesCount = 10 ;
    // LabelName/n.jpg  -->  France/1.jpg, France/2.jpg, Terry/1.jpg, Terry/2.jpg
    const distanceLimit = 0.4;
    
    const modelPath = 'https://13181leo.github.io/Alice/TensorFlow/Face-api/';
